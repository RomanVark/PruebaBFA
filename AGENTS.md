...
- Crea la clase de la acción en el paquete `org.roman.BFA.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="org.roman.BFA.acciones.MostrarImporte"/>
</controlador>
```

```java
package org.roman.BFA.acciones;
...
- ✅ Coloca las clases de acción en `org.roman.BFA.acciones`
...
- Crea un paquete `cuadrosmando` (ej. `org.roman.BFA.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
